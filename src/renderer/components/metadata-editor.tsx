      ...
      <div className="flex flex-col gap-3.5 p-4">
        ...
        <button
          ...
          className="no-drag group relative flex size-20 items-center justify-center overflow-hidden
            rounded-lg border border-glass-border bg-glass-hover transition-colors
        ...
        >
          {artworkPath ? (
            ...
            <div className="flex flex-col items-center gap-1 text-text-faint group-hover:text-accent-muted">
        ...
        {/* Output dir */}
        <div className="flex items-center gap-1.5 rounded-md border border-glass-border bg-glass px-2.5 py-2">
          ...
          <button
            ...
            className="no-drag shrink-0 font-mono text-[9px] text-accent-text transition-colors hover:text-accent"
          >
            Change
          </button>
        </div>
        ...
        <button
          type="button"
          onClick={onImportCue}
          className="no-drag flex items-center justify-center rounded-lg border border-glass-border-strong
            bg-glass py-2 font-mono text-[9px] tracking-[0.15em] text-text-muted uppercase
            transition-colors hover:border-accent-border hover:bg-accent-bg hover:text-accent-text"
        >
          Import .cue
        </button>
      </div>
  ...
  return (
    <label className="no-drag flex flex-col gap-1">
      ...
      <input
        ...
        className="rounded-md border border-glass-border bg-glass px-2.5 py-2 text-[13px] text-text-secondary
          outline-none transition-colors placeholder:text-text-ghost focus:border-accent-border"
      />
    </label>
  );
}
